...
ROOT_URLCONF = 'rasa_project.urls'
...
AUTHENTICATION_BACKENDS = [
    ...
    'auth_app.backend.UserAuthenticationBackend',  # Custom backend for Student mode   # Custom backend for Lecturer model   # Add any other authentication backends if needed
]
